...
<Warning>**Available on Enterprise plans.** Pull-mode connectors ship as part of the Enterprise multi-source governance ingestion stack. Apache 2.0 deployments use single-source `otel_generic` push only. See [Open-core licensing](/ai-governance/open-core-licensing).</Warning>
...
```ts
// platform/app/ee/governance/services/pullers/myCustom.puller.ts
