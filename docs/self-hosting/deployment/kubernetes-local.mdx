...
> **Developing LangWatch itself?** The `make quickstart` presets in the repo root are faster for day-to-day development. This Kind workflow is for testing the Helm chart packaging and Kubernetes-specific behavior.
